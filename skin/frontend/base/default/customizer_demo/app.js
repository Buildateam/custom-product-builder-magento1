...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsMasterJsx = __webpack_require__(159);

	var _componentsMasterJsx2 = _interopRequireDefault(_componentsMasterJsx);

	__webpack_require__(178);

	//import data from './model/guitar_data.js';

	var _modelGuitar_data_v2Js = __webpack_require__(177);

	var _modelGuitar_data_v2Js2 = _interopRequireDefault(_modelGuitar_data_v2Js);

	_reactDom2['default'].render(_react2['default'].createElement(_componentsMasterJsx2['default'], { data: _modelGuitar_data_v2Js2['default'] }), document.getElementById('customizer-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _headerHeaderJsx = __webpack_require__(160);

	var _headerHeaderJsx2 = _interopRequireDefault(_headerHeaderJsx);

	var _viewerViewerJsx = __webpack_require__(161);

	var _viewerViewerJsx2 = _interopRequireDefault(_viewerViewerJsx);

	var _control_panelControl_panelJsx = __webpack_require__(162);

	var _control_panelControl_panelJsx2 = _interopRequireDefault(_control_panelControl_panelJsx);

	var _additional_viewAdditional_viewJsx = __webpack_require__(176);

	var _additional_viewAdditional_viewJsx2 = _interopRequireDefault(_additional_viewAdditional_viewJsx);
	...
	var Master = (function (_React$Component) {
	  ...
	  function Master(props) {
	    ...
	    var groups = _modelGuitar_data_v2Js2['default'].groups;
	    this.state = {
	      userSelections: [0
	      /*
	      ,
	      ...
	      groups[1].subgroups[0]['options'][0],
	      ...
	      */
	      ...
	      myImgDir: customReactConfig.kitImgDir,
	      kitHiddenInputName: customReactConfig.kitHiddenInputName,
	      kitHiddenInputClassname: customReactConfig.kitHiddenInputClassname
	    };
	    ...
	    try {
	      for (var _iterator = groups[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var myGroup = _step.value;
	        var _iteratorNormalCompletion2 = true;
	        var _didIteratorError2 = false;
	        var _iteratorError2 = undefined;

	        try {
	          for (var _iterator2 = myGroup.subgroups[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            var mySubgroup = _step2.value;

	            mySubgroup.uiIndex = uiIndex;
	            var optionDefault = mySubgroup.name == 'Orientation' ? mySubgroup['options'][1] : mySubgroup['options'][0];
	            this.state.userSelections.push(optionDefault);
	            //this.state.userSelections[mySubgroup.order] = optionDefault;
	            uiIndex++;
	          }
	        } catch (err) {
	    ...
	    this.getOrientationKey = this.getOrientationKey.bind(this);
	  }

	  _createClass(Master, [{
	    key: '_setUserSelections',
	    value: function _setUserSelections(index, obj) {
	      //console.log('_setUserSelections');

	      var newUserSelections = Object.assign([], this.state.userSelections);
	      newUserSelections[index] = obj;
		  var isRighty = newUserSelections[1].name.toLowerCase().indexOf('right') != -1; // anatol

	      //let prices = newUserSelections.map(obj => obj.price);
	      // anatol
	      var orientKey = this.getOrientationKey(isRighty);
	      var prices = newUserSelections.map(function (obj) {
	        return typeof obj.price == 'object' ? obj.price[orientKey] : obj.price;
	      });

	      prices.shift();
	      var priceOfUserSelections = prices.reduce(function (a, b) {
	        return a + b;
	      });
	    ...
	    value: function _updateDescription(userOption) {
	      //console.log('_updateDescription');

	      var selectedName = userOption.name;
	      var selectedDescription = userOption.description;
	      var selectedPrice = userOption.price;

	      // anatol
	      if (typeof userOption.id == 'object') {
	        var orientKey = this.getOrientationKey(this.state.isRighty);
	        selectedDescription = userOption.description[orientKey];
	        selectedPrice = userOption.price[orientKey];
	      }

	      this.setState({ selectedName: selectedName, selectedDescription: selectedDescription, selectedPrice: selectedPrice });
	    }
	  }, {
	    key: 'updateToSelectedOptions',
	    value: function updateToSelectedOptions(subgroupIndex, userOption) {
	    ...
	    key: 'getOrientationKey',
	    value: function getOrientationKey(isRighty) {
	      //console.log('getOrientationKey');
	      var resOptionId = null;

	      var groups = this.props.data.groups;
	      for (var groupId in groups) {
	        var group = groups[groupId];
	        if (typeof group.subgroups != 'undefined') for (var subgroupId in group.subgroups) {
	          var subgroup = group.subgroups[subgroupId];
	          if (subgroup.name.toLowerCase() == 'orientation') {
	            var orientationSubgroup = subgroup;
	            if (typeof subgroup.options != 'undefined') for (var optionId in subgroup.options) {
	              var orientationOption = subgroup.options[optionId];
				  if (orientationOption.name.toLowerCase().indexOf('left') != -1) if (!isRighty) {
	                resOptionId = orientationOption.id;
	              }

				  if (orientationOption.name.toLowerCase().indexOf('right') != -1) if (isRighty) {
	                resOptionId = orientationOption.id;
	              }
	            }
	          }
	      ...
	      return resOptionId ? resOptionId.toString() : resOptionId;
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'main' },
	        _react2['default'].createElement(_headerHeaderJsx2['default'], _extends({}, this.props, {
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_viewerViewerJsx2['default'], {
	              layers: this.state.userSelections,
	              isRighty: this.state.isRighty,
	              isZoomed: this.state.isZoomed,
	              isNormal: this.state.isNormal,

	              getOrientationKey: this.getOrientationKey,
	              myImgDir: this.state.myImgDir,
	              kitHiddenInputName: this.state.kitHiddenInputName,
	              kitHiddenInputClassname: this.state.kitHiddenInputClassname
	            })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'large-1 medium-1 column align-middle' },
	            _react2['default'].createElement(
	              'div',
	              { className: 'float-center' },
	              _react2['default'].createElement(_additional_viewAdditional_viewJsx2['default'], _extends({}, this.props, {
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_control_panelControl_panelJsx2['default'], _extends({}, this.props, {
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	              ...
	              null,
	              "Total Price:  $",
	              this.props.priceOfUserSelections
	            )
	          )
	        )
	      );
	...
	var Viewer = (function (_React$Component) {
	  ...
	  _createClass(Viewer, [{
	    ...
	    value: function render() {
	      ...
	      var hand = this.props.isRighty ? 'R' : 'L';
	      var zoom = this.props.isZoomed ? 'zoomUrl' : 'imageUrl';
	      var imageSourceWithConfiguration = zoom + (hand + 'H');
	      ...
	      this.props.layers.forEach(function (layer, i) {
	        ...
	        var id = layer.id;
	        var src = layer[imageSourceWithConfiguration] === void 0 ? layer[zoom] : layer[imageSourceWithConfiguration];
	        var imgUrl = _this.props.myImgDir + src;

	        // anatol
	        if (typeof src == 'object') {
	          var orientKey = _this.props.getOrientationKey(_this.props.isRighty);
	          id = id[orientKey];
	          imgUrl = _this.props.myImgDir + src[orientKey];
	          if (parseInt(layer.is_salable[orientKey]) == 0) {
	            return 0;
	          }
			} else {
				if (parseInt(layer.is_salable) == 0) {
					return 0;
				}
			}
	        ...
	        layeredImage.push(_react2['default'].createElement('img', { style: { 'zIndex': i }, key: i, src: imgUrl, className: 'stacked-image' }));

	        hiddenFields.push(_react2['default'].createElement('input', { type: 'hidden', key: i + ' hidden', name: _this.props.kitHiddenInputName + '[' + layer.configurableProductId + ']', className: _this.props.kitHiddenInputClassname, value: id }));
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _accordionMain_accordionJsx = __webpack_require__(163);

	var _accordionMain_accordionJsx2 = _interopRequireDefault(_accordionMain_accordionJsx);
	...
	var ControlPanel = (function (_React$Component) {
	  ...
	  _createClass(ControlPanel, [{
	    key: 'setGroupAsActive',
	    value: function setGroupAsActive(group) {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_accordionMain_accordionJsx2['default'], _extends({}, this.props, {
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'kit-add-to-cart', style: { 'marginTop': '10px' } },
	          _react2['default'].createElement(
	            'button',
	            { type: 'button', title: 'Add to Cart', className: 'button btn-cart kit-btn-cart' },
	            _react2['default'].createElement(
	              'span',
	              null,
	              _react2['default'].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsCssTransitionGroup = __webpack_require__(164);

	var _reactAddonsCssTransitionGroup2 = _interopRequireDefault(_reactAddonsCssTransitionGroup);

	var _accordion_contentJsx = __webpack_require__(171);

	var _accordion_contentJsx2 = _interopRequireDefault(_accordion_contentJsx);

	var MainAccordion = (function (_React$Component) {
	  _inherits(MainAccordion, _React$Component);

	  function MainAccordion(props) {
	    _classCallCheck(this, MainAccordion);

	    _get(Object.getPrototypeOf(MainAccordion.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(MainAccordion, [{
	    key: 'setOptionAsActive',
	    value: function setOptionAsActive(optionIndex) {
	      var newIndex = optionIndex;
	    ...
	    value: function render() {
	      ...
	      var options = this.props.accordionOptions.map(function (accordionOption, i) {
	        return _react2['default'].createElement(
	          'div',
	          {
	            className: ' accordion-item ' + (i === _this.state.activeOptionIndex ? 'is-active' : '') + ' title',
	            key: i
	          },
	          _react2['default'].createElement(
	            'a',
	            { onClick: function () {
	                _this.setOptionAsActive(i, accordionOption);
	              }, className: 'accordion-title', role: 'tab' },
	            accordionOption['name']
	          ),
	          _react2['default'].createElement(_accordion_contentJsx2['default'], _extends({}, _this.props, {
	            isActive: i === _this.state.activeOptionIndex
	          }))
	        );
	      });
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: 'accordion', 'data-accordion': true, role: 'tablist' },
	        _react2['default'].createElement(
	          _reactAddonsCssTransitionGroup2['default'],
	          { transitionName: 'ease', transitionEnterTimeout: 500, transitionLeaveTimeout: 300 },
	          options
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _descriptionJsx = __webpack_require__(172);

	var _descriptionJsx2 = _interopRequireDefault(_descriptionJsx);

	var _palletPalletJsx = __webpack_require__(173);

	var _palletPalletJsx2 = _interopRequireDefault(_palletPalletJsx);

	var AccordionContent = (function (_React$Component) {
	  ...
	  _createClass(AccordionContent, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: classes, role: 'tabpanel', 'data-tab-content': true },
	        _react2['default'].createElement(
	          'div',
	          { className: 'row' },
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_palletPalletJsx2['default'], this.props)
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'small-4 columns' },
	            _react2['default'].createElement(_descriptionJsx2['default'], this.props)
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _subgroupSubgroupJsx = __webpack_require__(174);

	var _subgroupSubgroupJsx2 = _interopRequireDefault(_subgroupSubgroupJsx);
	...
	var Pallet = (function (_React$Component) {
	  ...
	  function Pallet() {
	    ...
	    _get(Object.getPrototypeOf(Pallet.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(Pallet, [{
	    ...
	    value: function render() {
	      ...
	      var subgroups = this.props.group.subgroups.map(function (subgroup) {
	        return _react2['default'].createElement(_subgroupSubgroupJsx2['default'], _extends({
	          subgroup: subgroup
	        }, _this.props, {
	          onSelectOption: _this.props.onSelectOption,
	          key: subgroup.name,
	          onMouseOver: _this.props.onOptionHover
	        }));
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pallet_optionJsx = __webpack_require__(175);

	var _pallet_optionJsx2 = _interopRequireDefault(_pallet_optionJsx);

	var Subgroup = (function (_React$Component) {
	  _inherits(Subgroup, _React$Component);

	  function Subgroup() {
	    _classCallCheck(this, Subgroup);

	    _get(Object.getPrototypeOf(Subgroup.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(Subgroup, [{
	    ...
	    value: function render() {
	      ...
	      var options = this.props.subgroup['options'].map(function (option) {
	        //let key33 = option.id;
	        var key33 = option.name; // anatol

	        return _react2['default'].createElement(_pallet_optionJsx2['default'], _extends({}, _this.props, {
	          option: option,
	          order: _this.props.subgroup.uiIndex,
	          onSelectOption: _this.props.onSelectOption,
	          key: key33
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PalletOption = (function (_React$Component) {
	  _inherits(PalletOption, _React$Component);

	  function PalletOption() {
	    _classCallCheck(this, PalletOption);

	    _get(Object.getPrototypeOf(PalletOption.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(PalletOption, [{
	    key: 'render',
	    value: function render() {
	      var _this = this;
	      ...
	      var iconUrl22 = this.props.myImgDir + option.iconUrl;
	      if (typeof option.iconUrl == 'object') {
	        var orientKey = this.props.getOrientationKey(this.props.isRighty);
	        iconUrl22 = this.props.myImgDir + option.iconUrl[orientKey];
	        if (parseInt(option.is_salable[orientKey]) == 0) {
	          return _react2['default'].createElement('div', { className: 'empty-div' });
	        }
		  } else {
			  if (parseInt(option.is_salable) == 0) {
				  return _react2['default'].createElement('div', { className: 'empty-div' });
			  }
		  }
	      ...
	      return _react2['default'].createElement(
	        'div',
	        {
	          ...
	          onClick: function () {
	            _this.props.onSelectOption(order, option);
	          }

	        },
	        _react2['default'].createElement('img', { className: 'thumbnail', src: iconUrl22 })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdditionalView = (function (_React$Component) {
	  _inherits(AdditionalView, _React$Component);

	  function AdditionalView() {
	    _classCallCheck(this, AdditionalView);

	    _get(Object.getPrototypeOf(AdditionalView.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(AdditionalView, [{
	    key: 'render',
	    value: function render() {

	      return _react2['default'].createElement(
	        'div',
	        { className: 'additional-view' },
	        _react2['default'].createElement(
	          'div',
	          { className: 'zoomed' },
	          _react2['default'].createElement('img', { className: 'thumbnail', onClick: this.props.setZoom, src: 'http://placehold.it/75x75?text=zoom' })
	        ),
	        _react2['default'].createElement(
	          'div',
	          { className: 'normal' },
	          _react2['default'].createElement('img', { className: 'thumbnail', onClick: this.props.setNormal, src: 'http://placehold.it/75x75?text=normal' })
	        )
	      );
	    }
	  }]);
	...
	exports['default'] = AdditionalView;
	module.exports = exports['default'];
...
/***/ function(module, exports) {
	...
	exports["default"] = {
	  groups: customReactConfig.kitGroups
	};
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#customizer-container .top-bar {\r\n  font-size: 20px;\r\n  font-weight: bold;\r\n  padding: 0;\r\n}\r\n\r\n#customizer-container .top-bar li > a,\r\n#customizer-container .top-bar-left ul li > a {\r\n  color: #2B6480;\r\n}\r\n\r\n#customizer-container .top-bar-right {\r\n  margin-top: 15px;\r\n  margin-right: 10px;\r\n  font-size: 18px;\r\n}\r\n\r\n\r\n#customizer-container .guitar-link:hover {\r\n  color: #729AB1;\r\n}\r\n\r\n#customizer-container .uke-link:hover {\r\n  color: #729AB1;\r\n}\r\n\r\n#customizer-container .bass-link:hover {\r\n  color: #729AB1;\r\n}\r\n\r\n#customizer-container .page {\r\n  padding-top: 1%;\r\n}\r\n\r\n#customizer-container .content {\r\n  padding-left: 1.5%;\r\n}\r\n\r\n#customizer-container .accordion{\r\n  border-width: 1px 0px 1px 0px;\r\n  border-color: rgb(230, 230, 230);\r\n  background-color: white;\r\n  margin: 0 auto;\r\n}\r\n\r\n#customizer-container .accordion-title {\r\n  font-size: 18px;\r\n  color: #2B6480;\r\n  font-weight: bold;\r\n  border: solid 1px;\r\n  border-color: rgb(232, 232, 240);\r\n padding: 1rem;\r\n  background-color: rgb(250, 250, 252);\r\n}\r\n\r\n#customizer-container .accordion-title:hover{\r\n  color: #729AB1;\r\n  background-color: rgb(250, 250, 252);\r\n}\r\n\r\n#customizer-container .accordion-active {\r\n  display: block;\r\n}\r\n\r\n#customizer-container .accordion-content {\r\n  font-size: 20px;\r\n  color: black;\r\n  margin-left: 5px;\r\n  margin-right: 5px;\r\n padding-bottom: 0;\r\n  margin-top: -10px;\r\n  border-style: solid;\r\n  border-width: 0px 1px 0px 1px;\r\n  border-color: rgb(230, 230, 230);\r\n  background-color: rgb(252, 252, 256);\r\n}\r\n\r\n#customizer-container .thumbnail {\r\n  border-left-width: 2px;\r\n  border-right-width: 2px;\r\n  border-top-width: 2px;\r\n  border-bottom-width: 2px;\r\n}\r\n\r\n#customizer-container .custom-option {\r\n  display: inline-block;\r\n  padding-top: 2%;\r\n  width: 50px;\r\n  height: 50px;\r\n}\r\n\r\n#customizer-container .header {\r\n  margin-bottom: -5px;\r\n  font-size: 16px;\r\n  margin-top: -5px;\r\n\r\n}\r\n\r\n#customizer-container .description-header {\r\n  margin-bottom: -10px;\r\n  margin-top: -5px;\r\n  font-size: 25px;\r\n  font-weight: bold;\r\n  display: inline-block;\r\n}\r\n\r\n#customizer-container .description-name {\r\n  color: #2B6480;\r\n  float: left;\r\n}\r\n\r\n#customizer-container .description-price {\r\n  text-align: right;\r\n  color: #B23B3B;\r\n  font-size: 15px;\r\n}\r\n\r\n#customizer-container .description-info {\r\n  color: #729AB1;\r\n  font-size: 18px;\r\n}\r\n\r\n\r\n/*Viewer Styles*/\r\n#customizer-container .previewer{\r\n  position: relative;\r\n  width: 480px;\r\n max-width: 100%;\r\n height: 520px;\r\n}\r\n\r\n#customizer-container .stacked-image{\r\n  position: absolute;\r\n  top: 0px;\r\n  left: 0px;\r\n  width: auto;\r\n  height: auto;\r\nmax-height: 100%;\r\n}\r\n", ""]);
