...
/**
 * KitProduct Price Model
 *
 * @category Mage
 * @package  MagentoAid_KitProduct
 * @author   Magento Core Team <core@magentocommerce.com>
 */
class MagentoAid_KitProduct_Model_Product_Price extends Mage_Catalog_Model_Product_Type_Price
{
    ...
    /**
     * Get Total price  for KitProduct items
     *
     * @param Mage_Catalog_Model_Product $product
     * @param null|float $qty
     * @return float
     */
    public function getTotalKitProductItemsPrice($product, $qty = null)
    {
        $price = 0.0;
    ...
    public function getFinalPrice($qty = null, $product)
    {
        ...
        $finalPrice += $this->getTotalKitProductItemsPrice($product, $qty);
     ...
     * @see MagentoAid_KitProduct_Model_Product_Price::getTotalPrices()
     *
     * @param  Mage_Catalog_Model_Product $product
     * @param  string                     $which
        ...
        if ($product->getData('min_price') && $product->getData('max_price')) {
            ...
            if ($options) {
                foreach ($options as $option) {
                    /* @var $option MagentoAid_KitProduct_Model_Option */
    ...
    /**
     * Calculate Minimal price of kitproduct (counting all required options)
     *
     * @param  Mage_Catalog_Model_Product $product
     * @return decimal
     */
    ...
    /**
     * Calculate maximal price of kitproduct
     *
     * @param Mage_Catalog_Model_Product $product
     * @return decimal
     */
     ...
     * @see MagentoAid_KitProduct_Model_Product_Price::getSelectionFinalTotalPrice()
     *
     * @param Mage_Catalog_Model_Product $kitproductProduct
     * @param Mage_Catalog_Model_Product $selectionProduct
     * @param float|null                 $selectionQty
     * @param null|bool                  $multiplyQty      Whether to multiply selection's price by its quantity
     * @return float
     */
    public function getSelectionPrice($kitproductProduct, $selectionProduct, $selectionQty = null, $multiplyQty = true)
    {
        return $this->getSelectionFinalTotalPrice($kitproductProduct, $selectionProduct, 0, $selectionQty, $multiplyQty);
    }

    /**
     * Calculate selection price for front view (with applied special of kitproduct)
     *
     * @param Mage_Catalog_Model_Product $kitproductProduct
     * @param Mage_Catalog_Model_Product $selectionProduct
     * @param decimal                    $qty
     * @return decimal
     */
    public function getSelectionPreFinalPrice($kitproductProduct, $selectionProduct, $qty = null)
    {
        return $this->getSelectionPrice($kitproductProduct, $selectionProduct, $qty);
    }
     ...
     * @param  Mage_Catalog_Model_Product $kitproductProduct
     * @param  Mage_Catalog_Model_Product $selectionProduct
     * @param  decimal                    $kitproductQty
     * @param  decimal                    $selectionQty
     * @param  bool                       $multiplyQty
     * @return decimal
     */
    public function getSelectionFinalPrice($kitproductProduct, $selectionProduct, $kitproductQty, $selectionQty = null,
       $multiplyQty = true)
    {
        return $this->getSelectionFinalTotalPrice($kitproductProduct, $selectionProduct, $kitproductQty, $selectionQty,
            $multiplyQty);
    }
     ...
     * @return decimal
     */
    public function getSelectionFinalTotalPrice($kitproductProduct, $selectionProduct, $kitproductQty, $selectionQty,
        $multiplyQty = true, $takeTierPrice = true)
    {
        ...
        return min($price,
            $this->_applyGroupPrice($kitproductProduct, $price),
            $this->_applyTierPrice($kitproductProduct, $kitproductQty, $price),
            $this->_applySpecialPrice($kitproductProduct, $price)
        );
    }

    /**
     * Apply group price for kitproduct product
     *
     * @param Mage_Catalog_Model_Product $product
    ...
    /**
     * Apply tier price for kitproduct
     *
     * @param   Mage_Catalog_Model_Product $product
     * @param   decimal                    $qty
    ...
    {
        $resource = Mage::getResourceSingleton('kitproduct/kitproduct');
        $selectionResource = Mage::getResourceSingleton('kitproduct/selection');
