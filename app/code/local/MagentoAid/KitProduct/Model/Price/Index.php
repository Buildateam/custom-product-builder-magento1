...
/**
 * KitProduct Product Price Index
 *
 * @method MagentoAid_KitProduct_Model_Resource_Price_Index _getResource()
 * @method MagentoAid_KitProduct_Model_Resource_Price_Index getResource()
 * @method MagentoAid_KitProduct_Model_Price_Index setEntityId(int $value)
 * @method int getWebsiteId()
 * @method MagentoAid_KitProduct_Model_Price_Index setWebsiteId(int $value)
 * @method int getCustomerGroupId()
 * @method MagentoAid_KitProduct_Model_Price_Index setCustomerGroupId(int $value)
 * @method float getMinPrice()
 * @method MagentoAid_KitProduct_Model_Price_Index setMinPrice(float $value)
 * @method float getMaxPrice()
 * @method MagentoAid_KitProduct_Model_Price_Index setMaxPrice(float $value)
 *
 * @category    Mage
 * @package     MagentoAid_KitProduct
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class MagentoAid_KitProduct_Model_Price_Index extends Mage_Core_Model_Abstract
{
    /**
    ...
    {
        $this->_init('kitproduct/price_index');
    }

    /**
     * Retrieve resource instance wrapper
     *
     * @return MagentoAid_KitProduct_Model_Mysql4_Price_Index
     */
     ...
     * @param int $productId
     * @param int $priceType
     * @return MagentoAid_KitProduct_Model_Price_Index
     */
    ...
    /**
     * Add kitproduct price range index to Product collection
     *
