 ...
 */
abstract class MagentoAid_KitProduct_Model_Sales_Order_Pdf_Items_Abstract extends Mage_Sales_Model_Order_Pdf_Items_Abstract
{
    /**
    ...
    /**
     * Retrieve KitProduct Options
     *
     * @param Varien_Object $item
     * @return array
     */
    public function getKitProductOptions($item = null)
    {
        $options = $this->getOrderItem()->getProductOptions();
        if ($options) {
            if (isset($options['kitproduct_options'])) {
                return $options['kitproduct_options'];
            }
        }
        return array();
    }
    ...
    public function getSelectionAttributes($item)
    {
        ...
        if (isset($options['kitproduct_selection_attributes'])) {
            return unserialize($options['kitproduct_selection_attributes']);
        }
        return null;
    }
