 ...
 */
class MagentoAid_KitProduct_Model_Sales_Order_Pdf_Items_Shipment extends MagentoAid_KitProduct_Model_Sales_Order_Pdf_Items_Abstract
{
    /**
     * Draw item line
     *
        ...
        foreach ($items as $_item) {
            ...
            if (($this->isShipmentSeparately() && $_item->getParentItem())
                ...
                if (isset($shipItems[$_item->getId()])) {
                    ...
                    $qty = Mage::helper('kitproduct')->__('N/A');
                } else {
                    $qty = 0;
                }
            } else {
