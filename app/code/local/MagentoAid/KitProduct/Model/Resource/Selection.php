...
/**
 * KitProduct Selection Resource Model
 *
 * @category    Mage
 * @package     MagentoAid_KitProduct
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class MagentoAid_KitProduct_Model_Resource_Selection extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('kitproduct/selection', 'selection_id');
    }
    ...
    public function getChildrenIds($parentId, $required = true)
    {
        ...
        $select = $adapter->select()
            ...
            ->join(
                array('tbl_option' => $this->getTable('kitproduct/option')),
    ...
    /**
     * Retrieve array of related kitproduct product ids by selection product id(s)
     *
    ...
    /**
     * Save kitproduct item price per website
     *
     * @param MagentoAid_KitProduct_Model_Selection $item
     */
    public function saveSelectionPrice($item)
    {
        $write = $this->_getWriteAdapter();
        if ($item->getDefaultPriceScope()) {
            $write->delete($this->getTable('kitproduct/selection_price'),
                array(
            ...
            $write->insertOnDuplicate(
                $this->getTable('kitproduct/selection_price'),
                $values,
