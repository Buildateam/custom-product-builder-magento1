...
/**
 * KitProduct Option Resource Model
 *
 * @category    Mage
 * @package     MagentoAid_KitProduct
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class MagentoAid_KitProduct_Model_Resource_Option extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('kitproduct/option', 'option_id');
    }
     ...
     * @return MagentoAid_KitProduct_Model_Resource_Option
     */
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $write->delete($this->getTable('kitproduct/option_value'), $condition);
        ...
        $write->insert($this->getTable('kitproduct/option_value'), $data->getData());
    ...
    protected function _afterDelete(Mage_Core_Model_Abstract $object)
    {
        ...
        $this->_getWriteAdapter()->delete(
            $this->getTable('kitproduct/option_value'),
    ...
    public function getSearchableData($productId, $storeId)
    {
        ...
        $select = $adapter->select()
            ...
            ->join(
                array('option_title_default' => $this->getTable('kitproduct/option_value')),
                'option_title_default.option_id = opt.option_id AND option_title_default.store_id = 0',
                array()
            )
            ->joinLeft(
                array('option_title_store' => $this->getTable('kitproduct/option_value')),
