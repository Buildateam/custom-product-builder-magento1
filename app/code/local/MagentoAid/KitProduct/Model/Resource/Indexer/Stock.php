...
/**
 * KitProduct Stock Status Indexer Resource Model
 *
 * @category    Mage
 * @package     MagentoAid_KitProduct
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class MagentoAid_KitProduct_Model_Resource_Indexer_Stock extends Mage_CatalogInventory_Model_Resource_Indexer_Stock_Default
{
    /**
     * Reindex temporary (price result data) for defined product(s)
     *
     * @param int|array $entityIds
     * @return MagentoAid_KitProduct_Model_Resource_Indexer_Stock
     */
    ...
    /**
     * Retrieve table name for temporary kitproduct option stock index
     *
     * @return string
     */
    protected function _getKitProductOptionTable()
    {
        return $this->getTable('kitproduct/stock_index');
    }

    /**
     * Prepare stock status per KitProduct options, website and stock
     *
     * @param int|array $entityIds
     * @param bool $usePrimaryTable use primary or temporary index table
     * @return MagentoAid_KitProduct_Model_Resource_Indexer_Stock
     */
    protected function _prepareKitProductOptionStockData($entityIds = null, $usePrimaryTable = false)
    {
        $this->_cleanKitProductOptionStockData();
        $idxTable = $usePrimaryTable ? $this->getMainTable() : $this->getIdxTable();
        $adapter  = $this->_getWriteAdapter();
        $select   = $adapter->select()
            ->from(array('bo' => $this->getTable('kitproduct/option')), array('parent_id'));
        ...
        // clone select for kitproduct product without required kitproduct options
        ...
        $query = $selectNonRequired->insertFromSelect($this->_getKitProductOptionTable());
        $adapter->query($query);
    ...
    {
        $this->_prepareKitProductOptionStockData($entityIds, $usePrimaryTable);
        ...
        $select->columns('cw.website_id')
            ...
            ->joinLeft(
                array('o' => $this->_getKitProductOptionTable()),
    ...
    /**
     * Clean temporary kitproduct options stock data
     *
     * @return MagentoAid_KitProduct_Model_Resource_Indexer_Stock
     */
    protected function _cleanKitProductOptionStockData()
    {
