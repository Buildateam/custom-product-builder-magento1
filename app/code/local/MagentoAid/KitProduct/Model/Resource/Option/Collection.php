...
/**
 * KitProduct Options Resource Collection
 *
 * @category    Mage
 * @package     MagentoAid_KitProduct
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class MagentoAid_KitProduct_Model_Resource_Option_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     * All item ids cache
     *
     ...
     *
     * @param int $storeId
     * @return MagentoAid_KitProduct_Model_Resource_Option_Collection
     */
    public function joinValues($storeId)
    {
        $this->getSelect()
            ->joinLeft(
                array('option_value_default' => $this->getTable('kitproduct/option_value')),
        ...
        if ($storeId !== null) {
            $this->getSelect()
                ...
                ->joinLeft(array('option_value' => $this->getTable('kitproduct/option_value')),
     ...
     *
     * @param MagentoAid_KitProduct_Model_Resource_Selection_Collection $selectionsCollection
