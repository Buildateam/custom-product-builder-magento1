...
/**
 * KitProduct selection renderer
 *
 * @category    Mage
 * @package     MagentoAid_KitProduct
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class MagentoAid_KitProduct_Block_Adminhtml_Catalog_Product_Edit_Tab_KitProduct_Option_Selection extends Mage_Adminhtml_Block_Widget
{
    /**
     * Initialize kitproduct option selection block
     */
    public function __construct()
    {
        $this->setTemplate('kitproduct/product/edit/kitproduct/option/opt.phtml');
    ...
    {
        return 'kitproduct_selections';
    }

    /**
     * Prepare block layout
     *
     * @return MagentoAid_KitProduct_Block_Adminhtml_Catalog_Product_Edit_Tab_KitProduct_Option_Selection
     */
        ...
        $this->setChild('selection_delete_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    ...
                    'class' => 'delete icon-btn right',
                    //'on_click' => 'bSelection.remove(event)'
                    'on_click' => 'bSelection.removeOption(this)',
                ))
        );
    ...
    public function getPriceTypeSelectHtml()
    {
        $select = $this->getLayout()->createBlock('adminhtml/html_select')
            ...
            ->setOptions(Mage::getSingleton('kitproduct/source_option_selection_price_type')->toOptionArray());
    ...
    {
        return $this->getUrl('*/kitproduct_selection/search');
    }
    ...
    public function getCheckboxScopeHtml()
    {
        ...
        if ($this->isUsedWebsitePrice()) {
            ...
            $class = 'kitproduct-option-price-scope-checkbox';
            $label = Mage::helper('kitproduct')->__('Use Default Value');
