...
class MagentoAid_KitProduct_Block_Catalog_Product_List_Partof extends Mage_Catalog_Block_Product_Abstract
{
    ...
    protected function _prepareData()
    {
        $collection = Mage::getModel('catalog/product')->getResourceCollection()
            ...
            ->joinTable('kitproduct/option', 'parent_id=entity_id', array('option_id' => 'option_id'))
            ->joinTable('kitproduct/selection', 'option_id=option_id', array('product_id' => 'product_id'), '{{table}}.product_id='.$this->getProduct()->getId());
